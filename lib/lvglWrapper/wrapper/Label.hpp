...
public:
  ...
  Label(const char *txt, Widget *parent) { Label(txt, parent->get()); }
  ...
  inline char *getText() { return lv_label_get_text(_obj); }
  ...
  inline bool getRecolor() { return lv_label_get_recolor(_obj); }
