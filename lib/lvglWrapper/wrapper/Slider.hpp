...
namespace lvgl
{
    ...
    {
        Slider(lv_obj_t *parent = lv_scr_act())
        {
        ...
        {
            return lv_slider_get_mode(_obj);
        }

        inline Slider &setValue(int32_t value, lv_anim_enable_t anim_en = LV_ANIM_OFF)
        {
        ...
        {
            return lv_slider_get_value(_obj);
        }
        ...
        inline Slider &setLeftValue(int32_t value, lv_anim_enable_t anim_en = LV_ANIM_OFF)
        {
        ...
        {
            return lv_slider_get_left_value(_obj);
        }
